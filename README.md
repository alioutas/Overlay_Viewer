...
# Overlay Viewer — Shinylive branch
...
> **This branch is the Shinylive (serverless) variant.** It runs the same app either
> as a normal Shiny server app *or* fully in the browser via WebAssembly, with no
> Python server at all. See [Shinylive build](#shinylive-build) below.
...
### What this branch changes to make that work
